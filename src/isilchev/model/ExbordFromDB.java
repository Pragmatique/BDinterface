 ...
 */
public class ExbordFromDB {
    private File folder;
    private final String fileName="DataFromDB.xlsx";
    //private int i=1;
    private Connection conn = null;
    private static double j=0;
    SimpleDoubleProperty dbl = new SimpleDoubleProperty(0);
    double doub;
    private Date dt1;
    private Date dt2;
    ...
    public ExbordFromDB(File folder,Connection conn,ProgressBar progressBar) {
        this.folder=folder;
        this.conn=conn;
    ...
    public ExbordFromDB(File folder,Connection conn,ProgressBar progressBar,LocalDate ld1,LocalDate ld2,String request) {
    ...
    public ExbordFromDB(File folder,Connection conn) {
        this.folder=folder;
        this.conn=conn;
    ...
    public void exporterAll()throws FileNotFoundException,IOException,SQLException, ParseException,InterruptedException {
        ...
        while (rs.next()){
            ...
            if ((double)i/rowNumber>j-0.01){
                ...
                System.out.println(rowNumber);
                System.out.println(row.getRowNum());
                System.out.println(Controller.dbl);
